...
<body>
	<div class="header">
     ...
     <div class="main">
        ...
        <div class="content_estudiantes">
          ...
          <div class="estudiantes_modificacion2">
            ...
            <p class="p2">Seccion</p>
                    ...
                    <div class="content_boton_año">

                      <div class="boton_filtrado_año">
                      ...
                      <div class="">
                        ...
                        <li values="1er_año">1er_año</li>
                        <li values="2do_año">2do_año</li>
                        <li values="3er_año">3er_año</li>
                        <li values="4to_año">4to_año</li>
                        <li values="5to_año">5to_año</li>
      ...
      <div class="cantidad">
        ...
        <p class="cantidad_estudiantes"> </p>
    ...
    <footer>
      ...
      <script src="./js/botones_seccion_año2.js">
