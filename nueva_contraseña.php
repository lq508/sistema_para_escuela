     ...
     <div class="main">
      <div class="shop_top3">
	     <div class="container4">
						<form action="./clases_php/cambio_final_contraseña.php" method="POST">
                    ...
                    <div class="">
                      <span>Contraseña nueva <label>*</label></span>
                      <input type="text" name="contraseña" >
                    </div>
                    <div class="">
                      <span>Repita la contraseña<label>*</label></span>
                      <input type="text" name="contraseña_verifiacion">
                    </div>
										<div>
